...
## 🚀 Project Overview
**CancerCare** is a Streamlit-based healthcare dashboard for medical image classification and genomic lookup.

* **Technologies Used:** Python, Streamlit, FastAPI, PyTorch, Ensembl REST API
...
* **Genomic Explorer:** Built a RESTful lookup flow using **FastAPI** and the Ensembl API for real-time gene and variant (rsID) lookups.
...
If you want the API backend instead, run:
